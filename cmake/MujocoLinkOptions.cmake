...
function(get_mujoco_extra_link_options OUTPUT_VAR)
  if(MSVC)
    ...
    if(WIN32)
      ...
      # LuckyEngine standardizes on the mold linker (provisioned by SysPackage.py),
      # so prefer it before lld/gold and avoid needing a second linker installed.
      set(CMAKE_REQUIRED_FLAGS "-fuse-ld=mold")
      check_c_source_compiles("int main() {}" SUPPORTS_MOLD)
      if(SUPPORTS_MOLD)
        set(EXTRA_LINK_OPTIONS ${EXTRA_LINK_OPTIONS} -fuse-ld=mold)
      else()
